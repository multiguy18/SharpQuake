...
namespace SharpQuake
{
    internal partial class Server
    {
        ...
        public static bool MoveStep( edict_t ent, ref v3f move, bool relink )
        {
            ...
            Mathlib.VectorAdd( ref ent.v.origin, ref move, out v3f neworg );
        ...
        {
            Mathlib.VectorAdd( ref ent.v.origin, ref ent.v.mins, out v3f mins );
            Mathlib.VectorAdd( ref ent.v.origin, ref ent.v.maxs, out v3f maxs );
