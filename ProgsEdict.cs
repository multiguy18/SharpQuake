    ...
    internal partial class Progs
    {
        ...
        private static void Test5_f()
        {
            ...
            for( int i = 0; i < Server.sv.edicts.Length; i++ )
            {
                ...
                Mathlib.Copy( ref ed.v.absmax, out OpenTK.Vector3 vmax );
                Mathlib.Copy( ref ed.v.absmin, out OpenTK.Vector3 vmin );
        ...
        private static int IndexOfFunction( string name )
        {
        ...
        private static int IndexOfField( string name )
        {
        ...
        private static unsafe void Set( int offset, int value )
        {
        ...
        private static unsafe int GetInt32( int offset )
        {
        ...
        private static int IndexOfField( int ofs )
        {
            for( int i = 0; i < _FieldDefs.Length; i++ )
            {
        ...
        private static unsafe bool IsEmptyField( int type, int* v )
        {
        ...
        private static unsafe bool ParseGlobalPair( ddef_t key, string value )
        {
