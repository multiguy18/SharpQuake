...
namespace SharpQuake
{
    ...
    // note that edge 0 is never used, because negative edge nums are used for counterclockwise use
    // of the edge in a face
    [StructLayout( LayoutKind.Sequential, Pack = 1 )]
    ...
    // leaf 0 is the generic CONTENTS_SOLID leaf, used for all solid areas all other leafs need
    // visibility info
    [StructLayout( LayoutKind.Sequential, Pack = 1 )]
