...
namespace SharpQuake
{
    internal static class Sbar
    {
        ...
        private static readonly glpic_t[,] _Nums = new glpic_t[2, 11];
        ...
        private static readonly glpic_t[,] _Weapons = new glpic_t[7, 8]; // 0 is active, 1 is owned, 2-5 are flashes
        private static readonly glpic_t[] _Ammo = new glpic_t[4];
        private static readonly glpic_t[] _Sigil = new glpic_t[4];
        private static readonly glpic_t[] _Armor = new glpic_t[3];
        private static readonly glpic_t[] _Items = new glpic_t[32];
        private static readonly glpic_t[,] _Faces = new glpic_t[7, 2]; // 0 is gibbed, 1 is dead, 2-6 are alive
        ...
        private static readonly glpic_t[] _RWeapons = new glpic_t[5];
        private static readonly glpic_t[] _RItems = new glpic_t[2];
        private static readonly glpic_t[] _RAmmo = new glpic_t[3];
        private static glpic_t _RTeamBord; // team color border
        private static readonly glpic_t[,] _HWeapons = new glpic_t[7, 5]; // 0 is active, 1 is owned, 2-5 are flashes

        private static readonly int[] _HipWeapons = new int[]
        {
            QItems.HIT_LASER_CANNON_BIT, QItems.HIT_MJOLNIR_BIT, 4, QItems.HIT_PROXIMITY_GUN_BIT
        };

        private static readonly glpic_t[] _HItems = new glpic_t[2];

        private static readonly int[] _FragSort = new int[QDef.MAX_SCOREBOARD];
        private static readonly string[] _ScoreBoardText = new string[QDef.MAX_SCOREBOARD];
        private static readonly int[] _ScoreBoardTop = new int[QDef.MAX_SCOREBOARD];
        private static readonly int[] _ScoreBoardBottom = new int[QDef.MAX_SCOREBOARD];
        private static readonly int[] _ScoreBoardCount = new int[QDef.MAX_SCOREBOARD];
